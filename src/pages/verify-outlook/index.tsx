...
export default function VerifyOutlookPage() {
  ...
  if (status === "loading") return <AuthLayout><section className="auth-card rounded-3xl border border-white/80 bg-white/90 p-9 text-center shadow-xl" aria-live="polite"><LoaderCircle className="mx-auto size-8 animate-spin text-brand-blue" /><h1 className="mt-5 text-2xl font-bold text-brand-navy">Confirming your email</h1><p className="mt-3 text-sm text-brand-slate">Please wait while we check your verification link.</p></section></AuthLayout>;
